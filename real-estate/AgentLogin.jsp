	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateAgentLogin.jsp" method="post">
							AgentId  : <input autocomplete="off" class="form-control" type="text" name="agentId" required="">
							<br><br>
							Password  : <input autocomplete="off" class="form-control" type="password" name="agentPassword" required="">
							<br><br>
