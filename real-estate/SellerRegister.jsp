	    		...
	    		<div class="row">
	    			...
	    			<div class="col-sm-4">
	    				...
	    				<form action="ValidateSellerRegister.jsp" method="get">
							SellerName  : <input autocomplete="off" class="form-control" type="text" name="sellerName" placeholder="your name.." required="">
							<br><br>
							SellerContactNumber  : <input autocomplete="off" class="form-control" type="text" name="sellerContact" pattern="[0-9]{10}" placeholder="10 digit phone number.." required="">
							<br><br>

							Password  : <input autocomplete="off" class="form-control" type="password" name="sellerPassword" pattern=".{8,}"  placeholder="eight or more characters password.." required="">
							<br><br>
